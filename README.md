...
dsl-rule.md            # kai-swimlane — the DSL specification (one grammar, no versions)
dsl-proposals.md       # the grammar candidates it was chosen from, plus the shared i18n / squash rules
examples/kai-swimlane/ # a complete worked example of the DSL and the fragments it imports
apps/
