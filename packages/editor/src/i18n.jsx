...
export const EN = {
  ...
  "action.exportTitle": "Export as .txt",
  "action.help": "Help",
  ...
  "settings.headerLeft": "Left",
  "settings.headerCenter": "Center",
  "settings.headerRight": "Right",
  "settings.footers": "Footers",
  "settings.footerLeft": "Left",
  "settings.footerCenter": "Center",
  "settings.footerRight": "Right",
  "settings.columnTitles": "Column titles",
  "settings.leftTitle": "Left title",
  "settings.leftSubtitle": "Left subtitle",
  "settings.rightTitle": "Right title",
  "settings.rightSubtitle": "Right subtitle",
  "settings.renderOptions": "Render options",
  ...
  "settings.showStepBlockCaptions": "Show block captions",
  "settings.mergeAtPreviousBlock": "Merge at previous block",
  "settings.branchColorArrows": "Color branch arrows",
  "settings.save": "Save",
  // fatal
...
export const JA = {
  ...
  "settings.headerLeft": "左",
  "settings.headerCenter": "中央",
  "settings.headerRight": "右",
  "settings.footers": "フッター",
  "settings.footerLeft": "左",
  "settings.footerCenter": "中央",
  "settings.footerRight": "右",
  "settings.columnTitles": "列のタイトル",
  "settings.leftTitle": "左タイトル",
  "settings.leftSubtitle": "左サブタイトル",
  "settings.rightTitle": "右タイトル",
  "settings.rightSubtitle": "右サブタイトル",
  "settings.renderOptions": "表示オプション",
  "settings.showLeftGutter": "左余白を表示",
  "settings.showRightGutter": "右余白を表示",
  "settings.showHeader": "ヘッダーを表示",
  "settings.showFooter": "フッターを表示",
  "settings.showDescription": "説明を表示",
  "settings.showStepBlockCaptions": "ブロックキャプションを表示",
  "settings.mergeAtPreviousBlock": "前のブロックでマージ",
  "settings.branchColorArrows": "分岐色矢印",
  "settings.save": "保存",
  // fatal
