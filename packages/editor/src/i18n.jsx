...
export const EN = {
  ...
  "gui.addMergeDesc": "Send this path straight to a later step, skipping the rest of the if.",
  ...
  "help.merge":
    "[goto: id] ends a case by jumping straight to the step that named itself with id: id;, instead of the end-if diamond.",
...
export const JA = {
  ...
  "gui.addMergeDesc": "この経路を、ifの残りを飛ばして後続のステップへ直接進めます。",
  ...
  "help.merge":
    "[goto: id] をケースの末尾に置くと、end-if の合流ダイヤモンドを使わず、id: id; で自分に名前を付けたステップへ直接ジャンプします。",
  "help.link":
