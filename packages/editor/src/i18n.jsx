...
export const EN = {
  ...
  "gui.addMergeMarker": "Landing marker",
  "gui.addLoop": "Loop back",
  "gui.addMerge": "Merge ahead",
  ...
  "gui.addMergeMarkerDesc": "Where a branch's merge lands — put it before the block to land on.",
  "gui.addLoopDesc": "Send this path back to the start of its if.",
  "gui.addMergeDesc": "Send this path forward — to the next landing marker, or a named one.",
  ...
  "branch.merge": "Merge",
  "branch.landingMarker": "Landing marker",
  "branch.row": "Row",
  ...
  "branch.mergeTargetNext": "Next landing marker after this if",
  "branch.mergeTargetHint": "This case skips the usual join point and jumps straight to that step.",
  "branch.markerName": "Landing marker name (optional)",
  "branch.markerNameHint":
    "A branch's bare merge lands on the next marker after its if; give it a name to target it from further away.",
...
export const JA = {
  ...
  "gui.addMergeMarkerDesc": "分岐の合流先——着地させたいブロックの直前に置きます。",
  "gui.addLoopDesc": "この経路をifの条件へ戻します。",
  "gui.addMergeDesc": "この経路を先へ進めます——次の合流地点、または名前付きの合流地点へ。",
  ...
  "branch.mergeTargetNext": "このifの次の合流地点",
  "branch.mergeTargetHint":
    "このケースは通常の合流地点を通らず、選んだステップへ直接ジャンプします。",
  "branch.markerName": "合流地点の名前（任意）",
  "branch.markerNameHint":
    "分岐の名前なしの合流は、そのifの次の合流地点に着地します。名前を付けると、離れた場所からもそこを指定できます。",
  // color
  "color.presets": "プリセット…",
  // preview
