...
export const EN: Record<string, string> = {
  ...
  "stepEdit.mergeId": "Landing point name (optional) — lets a branch rejoin here",
...
export const JA: Record<string, string> = {
  ...
  "stepEdit.arrow": "矢印",
  "stepEdit.mergeId": "合流ポイント名（任意） — 分岐の合流先にできます",
  "stepEdit.props": "プロップ",
