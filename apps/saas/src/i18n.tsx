...
export const EN: Record<string, string> = {
  ...
  "repoSettings.description":
    "Saved as {path} at the root of the repository, so the settings are versioned with the diagrams. The hub and the VS Code extension read the same file.",
  "repoSettings.branch": "Branch",
  "repoSettings.pending": "Pending on {branch} — it becomes a commit at the next checkpoint.",
  "repoSettings.pendingBadge": "pending",
  "repoSettings.readOnly": "These settings are read-only on {branch}.",
  "repoSettings.startEdit": "Start an edit",
  "repoSettings.startEditHint":
    "Settings are changed on an edit branch, like any other file in the repository.",
  "repoSettings.startEditPrompt": "Name this edit",
  "repoSettings.startEditDefault": "Repository settings",
  "repoSettings.goToEdit": "Open the editor to checkpoint",
  "repoSettings.modeForm": "Form",
  "repoSettings.modeJson": "JSON",
  "repoSettings.jsonHint":
    "The whole file. Saving reformats it to the canonical layout, so a settings diff only ever shows what changed.",
  "repoSettings.jsonInvalid": "Not valid JSON: {message}",
  "repoSettings.sectionRepository": "Repository",
  "repoSettings.sectionLayout": "Diagram layout",
  "repoSettings.sectionLayoutHint":
    "Sizes in pixels, applied to every diagram in this repository. An empty field uses the built-in default.",
  "repoSettings.group.margins": "Margins and gutters",
  "repoSettings.group.grid": "Swimlane grid",
  "repoSettings.diagramsRoot": "Diagrams folder",
  "repoSettings.diagramsRootHint":
    "Folder the diagram tree is rooted at. Leave empty to use the whole repository.",
  "repoSettings.diagramsRootWarning": "Changing this changes which files everyone sees.",
  "repoSettings.displayName": "Display name",
  "repoSettings.displayNameHint": "Shown instead of the repository name.",
  "repoSettings.theme": "Theme",
  "repoSettings.themeHint": "Default theme for this repository's diagrams.",
  "repoSettings.integrationBranch": "Integration branch",
  "repoSettings.integrationBranchHint":
    "For teams whose staging branch is not called test. Read by the hub and the VS Code extension.",
  "repoSettings.revert": "Revert to default",
  "repoSettings.revertAll": "Revert all",
  "repoSettings.defaultValue": "default {value}",
  "repoSettings.save": "Save",
  "repoSettings.saving": "Saving…",
  "repoSettings.saved": "Saved. Checkpoint {branch} to commit it.",
  "repoSettings.discard": "Discard pending change",
  "repoSettings.discarded": "Pending change discarded.",
  "repoSettings.noChanges": "No changes to save.",
  "repoSettings.layout.xPad": "Page side margin",
  "repoSettings.layout.leftGutterWidth": "Left gutter width",
  "repoSettings.layout.rightGutterWidth": "Right gutter width",
  "repoSettings.layout.gutterInnerPad": "Gutter inner padding",
  "repoSettings.layout.baseBottomPadding": "Bottom padding",
  "repoSettings.layout.topPadDefault": "Top padding",
  "repoSettings.layout.nodeW": "Lane column width",
  "repoSettings.layout.rowH": "Row height",
  "repoSettings.layout.headerH": "Lane header height",
  "repoSettings.layout.laneContentPad": "Lane content padding",
  "repoSettings.layout.outerLanePad": "Outer lane padding",
  // activity
...
export const JA: Record<string, string> = {
  ...
  "repoSettings.description":
    "リポジトリのルートに {path} として保存され、設定が図と一緒にバージョン管理されます。ハブと VS Code 拡張も同じファイルを読みます。",
  "repoSettings.branch": "ブランチ",
  "repoSettings.pending": "{branch} で保留中です。次のチェックポイントでコミットされます。",
  "repoSettings.pendingBadge": "保留中",
  "repoSettings.readOnly": "{branch} では設定を変更できません。",
  "repoSettings.startEdit": "編集を開始",
  "repoSettings.startEditHint": "設定は他のファイルと同じく、編集ブランチ上で変更します。",
  "repoSettings.startEditPrompt": "この編集の名前",
  "repoSettings.startEditDefault": "リポジトリ設定",
  "repoSettings.goToEdit": "エディタを開いてチェックポイント",
  "repoSettings.modeForm": "フォーム",
  "repoSettings.modeJson": "JSON",
  "repoSettings.jsonHint":
    "ファイル全体です。保存時に正規の書式へ整形されるため、設定の差分には変更点だけが現れます。",
  "repoSettings.jsonInvalid": "JSON として不正です: {message}",
  "repoSettings.sectionRepository": "リポジトリ",
  "repoSettings.sectionLayout": "図のレイアウト",
  "repoSettings.sectionLayoutHint":
    "単位はピクセルで、このリポジトリのすべての図に適用されます。空欄の場合は既定値を使います。",
  "repoSettings.group.margins": "余白とガター",
  "repoSettings.group.grid": "スイムレーングリッド",
  "repoSettings.diagramsRoot": "図のフォルダ",
  "repoSettings.diagramsRootHint":
    "図のツリーの起点となるフォルダです。空欄にするとリポジトリ全体を対象にします。",
  "repoSettings.diagramsRootWarning": "変更すると、全員に表示されるファイルが変わります。",
  "repoSettings.displayName": "表示名",
  "repoSettings.displayNameHint": "リポジトリ名の代わりに表示されます。",
  "repoSettings.theme": "テーマ",
  "repoSettings.themeHint": "このリポジトリの図の既定テーマです。",
  "repoSettings.integrationBranch": "統合ブランチ",
  "repoSettings.integrationBranchHint":
    "ステージングブランチが test でないチーム向けです。ハブと VS Code 拡張が参照します。",
  "repoSettings.revert": "既定値に戻す",
  "repoSettings.revertAll": "すべて既定値に戻す",
  "repoSettings.defaultValue": "既定 {value}",
  "repoSettings.save": "保存",
  "repoSettings.saving": "保存中…",
  "repoSettings.saved": "保存しました。{branch} をチェックポイントするとコミットされます。",
  "repoSettings.discard": "保留中の変更を破棄",
  "repoSettings.discarded": "保留中の変更を破棄しました。",
  "repoSettings.noChanges": "保存する変更はありません。",
  "repoSettings.layout.xPad": "ページ左右の余白",
  "repoSettings.layout.leftGutterWidth": "左ガターの幅",
  "repoSettings.layout.rightGutterWidth": "右ガターの幅",
  "repoSettings.layout.gutterInnerPad": "ガター内側の余白",
  "repoSettings.layout.baseBottomPadding": "下の余白",
  "repoSettings.layout.topPadDefault": "上の余白",
  "repoSettings.layout.nodeW": "レーン列の幅",
  "repoSettings.layout.rowH": "行の高さ",
  "repoSettings.layout.headerH": "レーンヘッダーの高さ",
  "repoSettings.layout.laneContentPad": "レーン内側の余白",
  "repoSettings.layout.outerLanePad": "外側レーンの余白",
  // activity
