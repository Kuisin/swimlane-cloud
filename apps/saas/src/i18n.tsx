...
export const EN: Record<string, string> = {
  ...
  "mobile.mergeTargetHint":
    "This case skips the rest of the if and continues from that step. Only steps that carry an id: can be named.",
  ...
  "stepEdit.mergeId": "Jump-target name (optional) — writes id: so a goto can name this step",
...
export const JA: Record<string, string> = {
  ...
  "mobile.mergeTargetHint":
    "このケースは if の残りを飛ばして、そのステップから続きます。指定できるのは id: を持つステップだけです。",
  ...
  "stepEdit.arrow": "矢印",
  "stepEdit.mergeId": "ジャンプ先の名前（任意） — id: 行を書き、goto から指定できるようにします",
  "stepEdit.props": "プロップ",
