...
export const EN: Record<string, string> = {
  ...
  "manual.notFound": "This section hasn't been written yet.",
  "manual.section.overview": "Overview",
  "manual.section.projects": "Projects",
  "manual.section.branches": "Branches & workflow",
  "manual.section.editing-gui": "Editing a diagram: Visual mode",
  "manual.section.editing-text": "Editing a diagram: Text mode",
  "manual.section.documents": "Documents (.md files)",
  "manual.section.mobile": "Editing on mobile",
  "manual.section.templates": "Reusable templates",
  "manual.section.versions": "Versions & publishing",
  "manual.section.pull-requests": "Review & pull requests",
  "manual.section.sharing": "Public sharing",
  ...
  "versions.publish.title": "Publish Approved as a new version",
  "versions.publish.version": "Version number",
  "versions.publish.invalid": "Use the form v1.2.3",
  "versions.publish.note": "Note (optional)",
  "versions.publish.noChanges": "Approved and Published are identical.",
  // history panel
  "history.empty": "No commits on this branch.",
  "history.view": "View",
  "history.unshare": "Unshare",
  "history.shareHint": "Share as a public link",
  "history.tip": "tip",
  // commit detail
  ...
  "version.promoteTo": "Publish",
  "version.ownerPromotes": "An admin publishes",
  "version.onMain": "Published",
  "version.share": "Share",
  "version.unshare": "Unshare",
  ...
  // document metadata: the form beside the prose, and the schema behind it
  "md.undeclared": "extra",
  ...
  "md.field.addPair": "Add a pair",
  "md.field.nested": "This value has its own structure. Edit it in the file itself.",
  "md.field.yes": "Yes",
  "md.field.no": "No",
  "md.problem.required": "This is required.",
  ...
  "metadata.description":
    "The keys a document's metadata may hold. Each one becomes a field in the Document tab, and a way to search the project. Saved in swimlane-settings.json on main.",
  "metadata.empty": "No keys declared yet. A document may still carry any metadata it likes.",
  "metadata.addField": "Add a key",
  "metadata.key": "key",
  "metadata.type": "Kind of value",
  "metadata.label": "Label shown to the author",
  "metadata.required": "Required",
  "metadata.default": "Default value",
  "metadata.values": "Choices (comma separated)",
  "metadata.help": "Help text",
  "metadata.moveUp": "Move up",
  "metadata.moveDown": "Move down",
  "metadata.type.string": "Text",
  "metadata.type.text": "Long text",
  "metadata.type.enum": "Choice",
  "metadata.type.list": "List",
  "metadata.type.date": "Date",
  "metadata.type.number": "Number",
  "metadata.type.boolean": "Yes / no",
  "metadata.type.map": "Nested keys",
  "metadata.enforcementHint":
    "Problems are shown as you type. A document that breaks these rules cannot be pushed to GitHub until it is fixed — the same as a forced section template.",
  "metadata.error.noKey": "Every key needs a name.",
  "metadata.error.badKey": "“{key}” is not a usable key: letters, digits, . _ and - only.",
  "metadata.error.duplicate": "“{key}” is declared twice.",
  "metadata.error.noChoices": "“{key}” is a choice, so it needs at least one choice.",
  // find documents by metadata
  "search.action": "Find",
  "search.title": "Find documents by metadata",
  "search.placeholder": "status:review, owner:sales-ops, or any word",
  "search.any": "Any",
  "search.clear": "Clear filters",
  "search.none": "No document matches.",
  "search.count": "{n} of {total} documents",
  "search.hasProblems": "This document breaks the project's metadata rules.",
  ...
  "mobile.searchFiles": "Search files",
  "mobile.noMatches": "No files match.",
  "mobile.renameFile": "Rename file",
  "mobile.renameFileName": "New file name",
  "mobile.renameConfirm": "Rename",
  "mobile.renameNoSlash": "Enter a file name, not a path.",
  "mobile.renameExists": "A file with that name already exists here.",
  "mobile.editBranch": "Edit condition",
  "mobile.editFork": "Edit parallel",
  "mobile.editSection": "Edit section",
  "mobile.editSubBranch": "Edit side path",
  "mobile.branchCondition": "Condition",
  "mobile.groupName": "Name",
  "mobile.highlightColor": "Highlight color",
  "mobile.colorDefault": "(default)",
  "mobile.editCase": "Edit case",
  "mobile.editPath": "Edit parallel path",
  "mobile.editMerge": "Edit jump (goto)",
  "mobile.caseLabel": "Case label",
  "mobile.caseLabelHint": 'Leave empty for "anything else"',
  "mobile.pathLabel": "Path label",
  "mobile.addCase": "Add case",
  "mobile.addPath": "Add parallel path",
  "mobile.newCase": "New case",
  "mobile.newCondition": "Condition",
  "mobile.mergeTarget": "Jump to step",
  "mobile.mergeTargetHint": "This case skips the rest of the if and continues from that step.",
  "mobile.mergeTargetUnset": "Not set — pick a step",
  "mobile.confirmDelete": "Delete — tap again",
  "mobile.addBlock": "Add branch or group",
  "mobile.add.if": "Branch (if)",
  "mobile.add.if.hint": "One path runs, chosen by a condition.",
  "mobile.add.fork": "Parallel (fork)",
  "mobile.add.fork.hint": "All paths run at the same time.",
  "mobile.add.section": "Group box",
  "mobile.add.section.hint": "Visual grouping only — the flow is unchanged.",
  "mobile.add.subBranch": "Side path",
  "mobile.add.subBranch.hint": "Splits off and rejoins the main flow later.",
  // arrow styles
  ...
  "settings.description":
    "Stored as swimlane-settings.json in the repository, so every diagram here — and every tool that reads the repository — follows the same rules. Changes are pending until the next checkpoint, like any other file.",
  ...
  "settings.save": "Save",
  "settings.saved": "Saved. Checkpoint {branch} to commit it.",
  "settings.ownerOnly": "Only the project owner can change these.",
  "settings.branch": "Branch",
  "settings.pending": "Pending on {branch} — it becomes a commit at the next checkpoint.",
  "settings.pendingBadge": "pending",
  "settings.readOnly": "These settings are read-only on {branch}.",
  "settings.readOnlyHint": "Settings change on an edit branch, like any other file.",
  "settings.startEdit": "Start an edit",
  "settings.goToCheckpoint": "Open the editor to checkpoint",
  "settings.discard": "Discard pending change",
  "settings.discarded": "Pending change discarded.",
  "settings.saving": "Saving…",
  "settings.mode.form": "Form",
  "settings.mode.json": "JSON",
  "settings.jsonHint":
    "The whole of {path}. Saving normalises it, so a settings diff only ever shows what changed.",
  "settings.jsonInvalid": "Not valid JSON: {message}",
  "settings.layout": "Page layout",
  "settings.layoutDescription":
    "Margins, gutter widths and the swimlane grid, in pixels. These are repository-wide: unlike the settings above, a diagram's own /option/ section cannot override them.",
  "settings.layoutHint": "An empty field uses the built-in default.",
  "settings.layoutGroup.margins": "Margins and gutters",
  "settings.layoutGroup.grid": "Swimlane grid",
  "settings.layoutDefault": "default {value}",
  "settings.revert": "Revert to default",
  "settings.revertAll": "Revert all",
  "settings.layoutField.xPad": "Page side margin",
  "settings.layoutField.leftGutterWidth": "Left gutter width",
  "settings.layoutField.rightGutterWidth": "Right gutter width",
  "settings.layoutField.gutterInnerPad": "Gutter inner padding",
  "settings.layoutField.baseBottomPadding": "Bottom padding",
  "settings.layoutField.topPadDefault": "Top padding",
  "settings.layoutField.nodeW": "Lane column width",
  "settings.layoutField.rowH": "Row height",
  "settings.layoutField.headerH": "Lane header height",
  "settings.layoutField.laneContentPad": "Lane content padding",
  "settings.layoutField.outerLanePad": "Outer lane padding",
  // templates settings
  ...
  "activity.action.version.shared": "shared a version",
  "activity.action.version.unshared": "unshared a version",
...
export const JA: Record<string, string> = {
  ...
  // in-app user manual
  "manual.sections": "目次",
  "manual.notFound": "このセクションはまだ書かれていません。",
  "manual.section.overview": "概要",
  "manual.section.projects": "プロジェクト",
  "manual.section.branches": "ブランチとワークフロー",
  "manual.section.editing-gui": "図の編集：ビジュアルモード",
  "manual.section.editing-text": "図の編集：テキストモード",
  "manual.section.documents": "ドキュメント（.md ファイル）",
  "manual.section.mobile": "モバイルでの編集",
  "manual.section.templates": "再利用テンプレート",
  "manual.section.versions": "バージョンと公開",
  "manual.section.pull-requests": "レビューとプルリクエスト",
  "manual.section.sharing": "公開共有",
  ...
  "versions.publish": "公開する",
  "versions.publish.title": "承認済みを新しいバージョンとして公開",
  "versions.publish.version": "バージョン番号",
  "versions.publish.invalid": "v1.2.3 の形式で入力してください",
  "versions.publish.note": "メモ（任意）",
  "versions.publish.noChanges": "承認済みと公開済みに差分はありません。",
  // history panel
  "history.empty": "このブランチにコミットはありません。",
  "history.view": "表示",
  "history.unshare": "共有を解除",
  "history.shareHint": "公開リンクとして共有",
  "history.tip": "最新",
  // commit detail
  ...
  "version.promoteTo": "公開する",
  "version.ownerPromotes": "管理者が公開します",
  "version.onMain": "公開済み",
  "version.share": "共有",
  "version.unshare": "共有を解除",
  ...
  "md.field.addPair": "キーと値を追加",
  "md.field.nested": "この値はさらに入れ子になっています。ファイル本体で編集してください。",
  "md.field.yes": "はい",
  "md.field.no": "いいえ",
  "md.problem.required": "必須項目です。",
  ...
  "metadata.description":
    "ドキュメントのメタデータに使えるキーを定義します。定義したキーは「ドキュメント」タブの入力欄になり、プロジェクト内の検索条件にもなります。main の swimlane-settings.json に保存されます。",
  "metadata.empty":
    "まだキーを定義していません。定義がなくてもドキュメントは自由にメタデータを持てます。",
  "metadata.addField": "キーを追加",
  "metadata.key": "キー",
  "metadata.type": "値の種類",
  "metadata.label": "編集者に表示する名前",
  "metadata.required": "必須",
  "metadata.default": "初期値",
  "metadata.values": "選択肢（カンマ区切り）",
  "metadata.help": "補足説明",
  "metadata.moveUp": "上へ",
  "metadata.moveDown": "下へ",
  "metadata.type.string": "テキスト",
  "metadata.type.text": "長いテキスト",
  "metadata.type.enum": "選択",
  "metadata.type.list": "リスト",
  "metadata.type.date": "日付",
  "metadata.type.number": "数値",
  "metadata.type.boolean": "はい / いいえ",
  "metadata.type.map": "入れ子のキー",
  "metadata.enforcementHint":
    "入力中は問題をその場で表示します。ルールに反するドキュメントは、直すまで GitHub にプッシュできません（セクションテンプレートの強制と同じ扱いです）。",
  "metadata.error.noKey": "すべてのキーに名前が必要です。",
  "metadata.error.badKey": "「{key}」は使えません。英数字と . _ - のみです。",
  "metadata.error.duplicate": "「{key}」が重複しています。",
  "metadata.error.noChoices": "「{key}」は選択なので、選択肢を1つ以上入れてください。",
  // find documents by metadata
  "search.action": "検索",
  "search.title": "メタデータでドキュメントを探す",
  "search.placeholder": "status:review、owner:sales-ops、または任意の語",
  "search.any": "すべて",
  "search.clear": "条件をクリア",
  "search.none": "一致するドキュメントはありません。",
  "search.count": "{total} 件中 {n} 件",
  "search.hasProblems": "このドキュメントはプロジェクトのメタデータ規則に反しています。",
  "mobile.addStep": "ステップを追加",
  "mobile.insertStep": "ステップを挿入",
  "mobile.confirmDeleteStep": "このステップを削除しますか？元に戻せません。",
  "mobile.files": "ファイル",
  "mobile.noFiles": "ファイルがありません。",
  "mobile.searchFiles": "ファイルを検索",
  "mobile.noMatches": "一致するファイルがありません。",
  "mobile.renameFile": "ファイル名を変更",
  "mobile.renameFileName": "新しいファイル名",
  "mobile.renameConfirm": "変更",
  "mobile.renameNoSlash": "パスではなくファイル名を入力してください。",
  "mobile.renameExists": "同じ名前のファイルがすでにあります。",
  "mobile.editBranch": "条件を編集",
  "mobile.editFork": "並列を編集",
  "mobile.editSection": "セクションを編集",
  "mobile.editSubBranch": "横道を編集",
  "mobile.branchCondition": "条件",
  "mobile.groupName": "名前",
  "mobile.highlightColor": "強調色",
  "mobile.colorDefault": "（デフォルト）",
  "mobile.editCase": "ケースを編集",
  "mobile.editPath": "並列の経路を編集",
  "mobile.editMerge": "ジャンプ（goto）を編集",
  "mobile.caseLabel": "ケース名",
  "mobile.caseLabelHint": "空欄にすると「それ以外」になります",
  "mobile.pathLabel": "経路名",
  "mobile.addCase": "ケースを追加",
  "mobile.addPath": "並列の経路を追加",
  "mobile.newCase": "新しいケース",
  "mobile.newCondition": "条件",
  "mobile.mergeTarget": "ジャンプ先のステップ",
  "mobile.mergeTargetHint": "このケースは if の残りを飛ばして、そのステップから続きます。",
  "mobile.mergeTargetUnset": "未設定——ステップを選んでください",
  "mobile.confirmDelete": "削除 — もう一度タップ",
  "mobile.addBlock": "分岐・グループを追加",
  "mobile.add.if": "条件分岐（if）",
  "mobile.add.if.hint": "条件に応じて、いずれか1つの経路だけを実行します。",
  "mobile.add.fork": "並列（fork）",
  "mobile.add.fork.hint": "すべての経路を同時に実行します。",
  "mobile.add.section": "グループ枠",
  "mobile.add.section.hint": "見た目のグループ化のみで、流れは変わりません。",
  "mobile.add.subBranch": "横道",
  "mobile.add.subBranch.hint": "本流から分かれ、あとで合流します。",
  // arrow styles
  ...
  "settings.description":
    "リポジトリの swimlane-settings.json に保存され、このリポジトリのすべての図と、リポジトリを読むすべてのツールが同じ規則に従います。変更は他のファイルと同様、次のチェックポイントまで保留されます。",
  "settings.diagram": "図",
  ...
  "settings.save": "保存",
  "settings.saved": "保存しました。{branch} をチェックポイントするとコミットされます。",
  "settings.ownerOnly": "変更できるのはプロジェクトのオーナーだけです。",
  "settings.branch": "ブランチ",
  "settings.pending": "{branch} で保留中です。次のチェックポイントでコミットされます。",
  "settings.pendingBadge": "保留中",
  "settings.readOnly": "{branch} では設定を変更できません。",
  "settings.readOnlyHint": "設定は他のファイルと同じく、編集ブランチ上で変更します。",
  "settings.startEdit": "編集を開始",
  "settings.goToCheckpoint": "エディタを開いてチェックポイント",
  "settings.discard": "保留中の変更を破棄",
  "settings.discarded": "保留中の変更を破棄しました。",
  "settings.saving": "保存中…",
  "settings.mode.form": "フォーム",
  "settings.mode.json": "JSON",
  "settings.jsonHint":
    "{path} の全体です。保存時に正規化されるため、設定の差分には変更点だけが現れます。",
  "settings.jsonInvalid": "JSON として不正です: {message}",
  "settings.layout": "ページレイアウト",
  "settings.layoutDescription":
    "余白・ガター幅・スイムレーングリッドをピクセルで指定します。リポジトリ全体の設定で、上の項目とは異なり図ごとの /option/ では上書きできません。",
  "settings.layoutHint": "空欄の場合は既定値を使います。",
  "settings.layoutGroup.margins": "余白とガター",
  "settings.layoutGroup.grid": "スイムレーングリッド",
  "settings.layoutDefault": "既定 {value}",
  "settings.revert": "既定値に戻す",
  "settings.revertAll": "すべて既定値に戻す",
  "settings.layoutField.xPad": "ページ左右の余白",
  "settings.layoutField.leftGutterWidth": "左ガターの幅",
  "settings.layoutField.rightGutterWidth": "右ガターの幅",
  "settings.layoutField.gutterInnerPad": "ガター内側の余白",
  "settings.layoutField.baseBottomPadding": "下の余白",
  "settings.layoutField.topPadDefault": "上の余白",
  "settings.layoutField.nodeW": "レーン列の幅",
  "settings.layoutField.rowH": "行の高さ",
  "settings.layoutField.headerH": "レーンヘッダーの高さ",
  "settings.layoutField.laneContentPad": "レーン内側の余白",
  "settings.layoutField.outerLanePad": "外側レーンの余白",
  ...
  "activity.action.version.shared": "バージョンを共有",
  "activity.action.version.unshared": "バージョンの共有を解除",
